...
/*	@iOSFindBy(className="") // ipgone locator strat
	...
	// ANDROID    
	    ...
	    CL.getTestDataInstance().SetAppFilePath("C:/Automation/MIT_Builds/Android/banking-wealth-17.4.2-20170509.213045-29-debug.apk"); //path at simulator server
	      CL.mobileApp("http://0.0.0.0:4727/wd/hub"); // android
	    }
	// iOS
	    else
	    {
		  CL.getTestDataInstance().SetAppFilePath("/opt/app/banking-wealth-17.3.1-20170519.225543-822-ENTERPRISE-DEBUG-TESTING.ipa"); //path at iOS Mac Mini
	     CL.mobileApp("http://49.19.17.226:4726/wd/hub"); // iOS Mac Pro
