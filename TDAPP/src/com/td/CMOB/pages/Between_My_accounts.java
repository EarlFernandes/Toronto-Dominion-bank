...
public class Between_My_accounts extends _CommonPage {
    ...
    private MobileElement confirmHeader;
	...
	try {
		...
		mobileAction.verifyElementIsDisplayed(accountVal, "From Account");
	    }
	} catch (NoSuchElementException | InterruptedException | IOException e) {
	    System.err.println("TestCase has failed.");
	    CL.getGlobalVarriablesInstance().bStopNextFunction = false;
	...
	try {
		...
		// Firstpart, accountsSecondPart,from_accountNo );
		Thread.sleep(2000);
		mobileAction.verifyElementTextContains(activityConfText, confirmationValue[1].trim());
	...
	try {
	     ...
	     * CAD_account, 2, "down", true);
	     * mobileAction.verifyElementIsDisplayed(CAD_account,
	     * "Canadian dollar account");
	     * 
	     * mobileAction.FuncElementSwipeWhileNotFound(acntsList, US_account,
	     * 2, "down", true);
	     * mobileAction.verifyElementIsDisplayed(US_account,
	     * "US dollar account");
	     * 
	     * mobileAction.FuncElementSwipeWhileNotFound(acntsList,
	     * Wealth_CAD_account, 2, "down", true);
	     * mobileAction.verifyElementIsDisplayed(Wealth_CAD_account,
	     * "Wealth Canadian account");
	     * 
	     * mobileAction.FuncElementSwipeWhileNotFound(acntsList,
	     * Wealth_US__account, 2, "down", true);
	     * mobileAction.verifyElementIsDisplayed(Wealth_US__account,
	     * "Wealth US account");
	     */
	...
	try {
		...
		mobileAction.FuncClick(continue_transfer, "Continue");
		mobileAction.waitForElementToVanish(progresssBar);
		mobileAction.verifyElementIsDisplayed(confirmHeader, "Confirm Page");
		mobileAction.FuncClick(cancelBtn, "Cancel");
    ...
    /**
     * This method will transfer whether the Trust CDN Chequing Account" to
     * Trust USD Chequing Account
     * 
     * @return void
     * @throws Exception
     * 
    ...
    public void transferCAD04ToU05_chequingAmount() throws Exception {
	...
	try {
		...
		if (CL.getTestDataInstance().getMobilePlatForm().equalsIgnoreCase("ios")) {
		    ...
		    mobileAction.FuncClick(done, "Done");
		    mobileAction.FuncClick(continue_transfer, "Continue");
		    mobileAction.verifyElementIsDisplayed(confirmHeader, "ConfirmHeader");

		    Thread.sleep(100000);

		    mobileAction.FuncClick(finish_transfer, "Finish Transfer");
    ...
    /**
     * This method will transfer whether the "Canada Trust CDN Savings Account"
     * to "US Margin (F)"
     * 
     * @return void
     * @throws Exception
    ...
    public void transferCAD05ToU02_chequingAmount() throws Exception {
	Decorator();
	try {
	    if (btw_My_Accounts_Header.isDisplayed() == true) {
		mobileAction.FuncClick(from_acnt, "From Account");
    ...
    public void transferCAD08ToU03_chequingAmount() throws Exception {
	Decorator();
	try {
	    if (btw_My_Accounts_Header.isDisplayed() == true) {
		mobileAction.FuncClick(from_acnt, "From Account");
    ...
    public void transferCAD07ToU05_chequingAmount() throws Exception {
	Decorator();
	try {
	    if (btw_My_Accounts_Header.isDisplayed() == true) {
		mobileAction.FuncClick(from_acnt, "From Account");
    ...
    public void transferU06ToCAD09_chequingAmount() throws Exception {
	Decorator();
	try {
	    if (btw_My_Accounts_Header.isDisplayed() == true) {
		mobileAction.FuncClick(from_acnt, "From Account");
    ...
    public void transferCAD11ToU06_chequingAmount() throws Exception {
	Decorator();
	try {
	    if (btw_My_Accounts_Header.isDisplayed() == true) {
		mobileAction.FuncClick(from_acnt, "From Account");
    ...
    public void transferU04ToC18_chequingAmount() throws Exception {
	Decorator();
	try {
	    if (btw_My_Accounts_Header.isDisplayed() == true) {
		mobileAction.FuncClick(from_acnt, "From Account");
    ...
    public void transferCAD11ToU04_chequingAmount() throws Exception {
	Decorator();
	try {
	    if (btw_My_Accounts_Header.isDisplayed() == true) {
		mobileAction.FuncClick(from_acnt, "From Account");
    ...
    public void transferU05ToCAD16_chequingAmount() throws Exception {
	Decorator();
	try {
	    if (btw_My_Accounts_Header.isDisplayed() == true) {
		mobileAction.FuncClick(from_acnt, "From Account");
    ...
    public void transferCAD09ToU01_chequingAmount() throws Exception {
	Decorator();
	try {
	    if (btw_My_Accounts_Header.isDisplayed() == true) {
		mobileAction.FuncClick(from_acnt, "From Account");
