...
public class WatchLists extends _CommonPage{
	...
	MobileElement symbol = (MobileElement) ((AppiumDriver) CL.GetDriver())
			.findElement(By.xpath(symbolXpath));		
	...
	public void deleteSymbolsFromList(){
		...
		String SymbolXpath="//android.widget.TextView[@resource-id='com.td:id/symbol' and contains(@text,'"+symbolList[i]+"')]";
		MobileElement Symbol = (MobileElement) ((AppiumDriver) CL.GetDriver())
				.findElement(By.xpath(SymbolXpath));
