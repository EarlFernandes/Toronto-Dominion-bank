 ...
 *
 */
public class TDIOTPChallenge extends _CommonPage {

	private static TDIOTPChallenge OneTimePasswordChallenge;
	...
	public synchronized static TDIOTPChallenge get() {
		if (OneTimePasswordChallenge == null) {
			OneTimePasswordChallenge = new TDIOTPChallenge();
		}
