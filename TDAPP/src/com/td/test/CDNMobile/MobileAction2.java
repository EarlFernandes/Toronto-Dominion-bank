...
try{
	...
	/**
	  * This method will can be used in case FuncSwipeAndScroll is throwing  any exception.
	  * @param elementToFind
	  * @param clickYorN
	  * @throws Exception
	  */
	  ...
	  System.out.println("Inside funcNewSwipe");
	  ...
	  /**
		...
		public boolean verifyLoginErrorOccured(String mobileElement) throws InterruptedException, IOException {
			try {
				WebDriverWait wait = new WebDriverWait((AppiumDriver) GetDriver(), 20);
