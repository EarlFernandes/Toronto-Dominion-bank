...
public class MLConfirmOrderReceipt extends _CommonPage {
	...
	@iOSFindBy(xpath = "//*[@label='Orders' or @label='Ordres']") //@Author - Sushil 23-Mar-2017
	@AndroidFindBy(id="com.td:id/btn_order")
	private MobileElement btn_ORDERS;
	
	@iOSFindBy(xpath = "//XCUIElementTypeStaticText[contains(@label,'Multi-Leg') or contains(@label,'Composantes multiples')]") //@Author - Sushil 23-Feb-2017
	...
	@iOSFindBy(xpath = "//*[contains(@label,'Thank you!') or contains(@label,'Merci!')]") //@Author - Sushil 21-Mar-2017
	@AndroidFindBy(xpath = "//*[contains(@text,'Thank you!') or contains(@text,'Merci!')]")
	private MobileElement lblThankYou;

	@iOSFindBy(xpath = "//*[@label='Order sent successfully' or contains(@label,'Ordre transmis avec')]") //@Author - Sushil 21-Mar-2017
	...
	@iOSFindBy(xpath = "//*[contains(@label,'Leg Confirmation') or contains(@label,'de confirmation')]") //@Author - Sushil 21-Mar-2017
	@AndroidFindBy(xpath = "//*[@text='Leg Confirmation' or contains(@text,'de confirmation')]")
	private MobileElement legConfirmationNumber;	
	
	@iOSFindBy(xpath = "//*[contains(@label,'Leg Confirmation') or contains(@label,'Commande')]") //@Author - Sushil 21-Mar-2017
	...
	@iOSFindBy(xpath = "//*[contains(@label,'Order Placed') or contains(@label,'Ordre pass')]/../*[2]") //@Author - Sushil 21-Mar-2017
	...
	@iOSFindBy(xpath = "//*[@label='1st Leg' or @label='1re Volet']/../*[2]") //@Author - Sushil 21-Mar-2017
	...
	@iOSFindBy(xpath = "//*[@label='2nd Leg' or @label='2e Volet']/../*[2]") //@Author - Sushil 21-Mar-2017
	@AndroidFindBy(xpath = "//*[@text='2nd Leg' or @text='2e Volet']/../*[2]/*[1]")
	private MobileElement leg2Details;
	
	@iOSFindBy(xpath = "//XCUIElementTypeStaticText[@label='Price' or @label='Cours']") //@Author - Sushil 21-Mar-2017
	...
	@iOSFindBy(xpath = "//XCUIElementTypeButton[@label='Home' or @label='Accueil']") //@Author - Sushil 23-Mar-2017
	...
	@iOSFindBy(xpath = "//*[@label='My Accounts' or @label='Mes comptes']") //@Author - Sushil 23-Mar-2017
    ...
    @iOSFindBy(xpath = "//XCUIElementTypeOther[@label='Accounts' or @label='Comptes']") //@Author - Sushil 23-Mar-2017
    @AndroidFindBy(id="com.td:id/classificationTexView")
    private MobileElement lblBanking;
	
	@iOSFindBy(xpath = "//*[@label='Investing Accounts' or contains(@label='Mes comptes)']") //@Author - Sushil 23-Mar-2017
	@AndroidFindBy(id="com.td:id/btn_order")
	private MobileElement inVestingAccounts;
	

	@iOSFindBy(xpath = "//*[@label='Trade' or @label='N�gociation']") //@Author - Sushil 23-Mar-2017
	@AndroidFindBy(xpath = "//*[(@text='Trade' or @text='N�gociation') and @resource-id='com.td:id/navText']")
	...
	public void verifyStockOptionConfirmOrderReceipt()
	{
		Decorator();
		try{
			//mobileAction.FuncGetValByRegx("1st Leg Confirmation # : QS-020043 2nd Leg Confirmation # : QS-020044","([A-Z]+)(-)([0-9]+)");
			//Thread.sleep(30000);
...
//			String sCurrentDay = format2.split(";")[0];
	...
	/*		String sCurrentMonth = format2.split(";")[2];
			...
			mobileAction.verifyElementTextContains(leg1Details, getTestdata("Action",XLSheetUserIDs) + " " + getTestdata("Leg1Qunatity",XLSheetUserIDs) + " " + getTestdata("Symbol",XLSheetUserIDs));
		
			mobileAction.verifyElementIsDisplayed(lbl2ndLeg, "2nd Leg");
			mobileAction.verifyElementTextContains(leg2Details, getTestdata("Leg2Action2",XLSheetUserIDs) + " " + getTestdata("Leg2Qunatity",XLSheetUserIDs) + " " + getTestdata("Symbol",XLSheetUserIDs));
...
//			String sCurrentDay = format2.split(";")[0];
	...
	/*		String sCurrentMonth = format2.split(";")[2];
			...
			mobileAction.verifyElementIsDisplayed(lbl1stLeg, "1st Leg");
			mobileAction.verifyElementTextContains(leg1Details, getTestdata("Leg1Action2",XLSheetUserIDs) + " " + getTestdata("Leg1Qunatity",XLSheetUserIDs) + " " + getTestdata("Symbol",XLSheetUserIDs));
