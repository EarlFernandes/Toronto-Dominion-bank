...
public class MenuPage extends _CommonPage {
	...
	@iOSFindBy(xpath = "//XCUIElementTypeStaticText[@label='Trade' or @label='NÈgociation']")
	@AndroidFindBy(xpath = "//android.widget.TextView[@resource-id='android:id/action_bar_title' and (@text='Trade' or @text='NÈgociation')]")
