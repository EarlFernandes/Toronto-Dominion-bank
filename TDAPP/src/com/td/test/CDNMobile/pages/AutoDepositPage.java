...
public class AutoDepositPage extends _CommonPage {
	...
	@iOSXCUITFindBy(iOSClassChain = "**/XCUIElementTypeButton[`label=='Set up Autodeposit'`]")
	...
	@iOSXCUITFindBy(iOSClassChain = "**/*[`label CONTAINS[cd] 'My Name'`]")
	...
	@iOSXCUITFindBy(iOSClassChain = "**/*[`value=='Enter email address'`]")
	...
	@iOSXCUITFindBy(iOSClassChain = "**/*[`value=='Re-enter email address'`]")
	...
	@iOSXCUITFindBy(iOSClassChain = "**/*[`label CONTAINS[cd] 'Choose an account'`]")
	...
	@iOSXCUITFindBy(iOSClassChain = "**/*[`label=='Continue'`]")
	...
	@iOSXCUITFindBy(iOSClassChain = "**/*[`label=='Almost done!'`]")
	@AndroidFindBy(xpath = "//android.widget.TextView[@resource-id='com.td:id/receipt_header']")
	private MobileElement almostDone;

	@iOSXCUITFindBy(iOSClassChain = "**/*[`value CONTAINS[cd] 'Check your email for instructions'`]")
	...
	@iOSXCUITFindBy(iOSClassChain = "**/XCUIElementTypeButton[`label CONTAINS[cd] 'Deposit To'`]")
	...
	@iOSXCUITFindBy(iOSClassChain = "**/XCUIElementTypeOther[`label CONTAINS[cd] 'Email Address'`]")
	@AndroidFindBy(xpath = "//android.widget.TextView[@resource-id='com.td:id/manage_auto_deposit_email_title']")
	private MobileElement email;

	@iOSXCUITFindBy(iOSClassChain = "**/XCUIElementTypeOther[`label CONTAINS[cd] 'My Name'`]")
	@AndroidFindBy(xpath = "//android.widget.TextView[@resource-id='com.td:id/manage_auto_deposit_email_title']")
	private MobileElement myname;
	...
	@iOSXCUITFindBy(iOSClassChain = "**/XCUIElementTypeOther[`label=='Done'`]")
	@AndroidFindBy(xpath = "//android.widget.Button[@resource-id='com.td:id/btn_footer']")
	private MobileElement doneButton;

	@iOSXCUITFindBy(iOSClassChain = "**/*[`label CONTAINS[cd] 'Set up Autodeposit'`]")
	@AndroidFindBy(xpath = "//android.widget.Button[@resource-id='com.td:id/btn_footer']") // TODO::AndroidElementNotAvailable
	private MobileElement autoDepositBanner;

	@iOSXCUITFindBy(iOSClassChain = "**/*[`name=='TDVIEW_TITLE' and label=='Autodeposit'`]")
	@AndroidFindBy(xpath = "//android.widget.TextView[@resource-id='android:id/action_bar_title']")
	private MobileElement pageHeader;

	@iOSXCUITFindBy(iOSClassChain = "**/*[`label=='Select a recipient'`]")
	...
	@iOSXCUITFindBy(xpath = "//XCUIElementTypeStaticText[@label='Deposit to']/following-sibling::XCUIElementTypeStaticText")
	...
	@iOSXCUITFindBy(iOSClassChain = "**/XCUIElementTypeButton[`label=='Continue' or label=='Request Money' or label=='Next'`]")
		...
		try {
			...
			if (platform.equalsIgnoreCase("Android")) {
				mobileAction.verifyTextEquality(almostDone.getText(),
						mobileAction.getAppString("add_auto_deposit_receipt_header"));
				mobileAction.verifyTextEquality(checkEmailMsg.getText(),
						mobileAction.getAppString("add_auto_deposit_receipt_sub_header"));
			} else {

				mobileAction.verifyTextEquality(almostDone.getText(),
						getTextInCurrentLocale(StringArray.ARRAY_AUTODEPOSIT_ALMOST_DONE));
				mobileAction.verifyTextEquality(checkEmailMsg.getText(),
	...
	public void clickAutoDeposit() {
		...
		try {
			...
			if (StringUtils.isEmpty(autodepositStatus)) {
				autodepositStatus = "Pending";
			}

			if (platform.equalsIgnoreCase("Android")) {

				if (autodepositStatus.equalsIgnoreCase("Pending")) {
	...
	public void editAutoDeposit() {
		...
		try {
			...
			if (autodepositAcc.getText().equalsIgnoreCase(accounts[0])) {
