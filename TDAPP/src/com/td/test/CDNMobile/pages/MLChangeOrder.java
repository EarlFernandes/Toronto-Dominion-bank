...
public class MLChangeOrder extends _CommonPage {
	...
	//@AndroidFindBy(xpath = "//*[contains(@text,'1st') or contains(@text,'1re')]/../following-sibling::android.widget.LinearLayout[@resource-id='com.td:id/item_row_value_main']/*[1]")
	...
	@iOSFindBy(xpath = "//*[contains(@label,'1st') or contains(@label,'1re')]/../following-sibling::XCUIElementTypeCell[3]/*[2]") //@Author - Sushil 16-Feb-2017
	//@AndroidFindBy(xpath = "//*[contains(@text,'1st') or contains(@text,'1re')]/../following-sibling::android.widget.LinearLayout[@resource-id='com.td:id/ticker_layout']/android.widget.TextView")
	@AndroidFindBy(xpath = "//*[contains(@text,'1st') or contains(@text,'1re')]/../following-sibling::*/*/*/*/*[@resource-id='com.td:id/amountEditText']")
	private MobileElement leg1Quantity;
	
	
	@iOSFindBy(xpath = "//*[contains(@label,'1st') or contains(@label,'1re')]/../following-sibling::XCUIElementTypeCell[4]/*[2]") //@Author - Sushil 16-Feb-2017
	//@AndroidFindBy(xpath = "//*[contains(@text,'1st') or contains(@text,'1re')]/../following-sibling::android.widget.LinearLayout[@resource-id='com.td:id/ticker_layout']/android.widget.TextView")
	...
	@iOSFindBy(xpath = "//*[contains(@label,'2nd') or contains(@label,'2e')]/../following-sibling::XCUIElementTypeCell/*") //@Author - Sushil 16-Feb-2017
	...
	@iOSFindBy(xpath = "//*[contains(@label,'2nd') or contains(@label,'2e')]/../following-sibling::XCUIElementTypeCell[3]/*[2]") //@Author - Sushil 16-Feb-2017
	//@AndroidFindBy(xpath = "//*[contains(@text,'1st') or contains(@text,'1re')]/../following-sibling::android.widget.LinearLayout[@resource-id='com.td:id/ticker_layout']/android.widget.TextView")
	...
	@iOSFindBy(xpath = "//*[contains(@label,'2nd') or contains(@label,'2e')]/../following-sibling::XCUIElementTypeCell[4]/*[2]") //@Author - Sushil 16-Feb-2017
	//@AndroidFindBy(xpath = "//*[contains(@text,'1st') or contains(@text,'1re')]/../following-sibling::android.widget.LinearLayout[@resource-id='com.td:id/ticker_layout']/android.widget.TextView")
...
public void getStockOptionChangeOrderData()
{
	try
	{
		...
		//sLeg2Action21 = getTestdata("Leg2Action2",XLSheetUserIDs).split(";")[1];
...
public void getOptionOptionChangeOrderData()
{
	try
	{
		...
		//sLeg1Action21 = getTestdata("Leg1Action2",XLSheetUserIDs).split(";")[1];
		//sLeg2Action21 = getTestdata("Leg2Action2",XLSheetUserIDs).split(";")[1];
		sLeg1Qunatity1 = getTestdata("Leg1Qunatity",XLSheetUserIDs).split(";")[1];
		sLeg2Qunatity1 = getTestdata("Leg2Qunatity",XLSheetUserIDs).split(";")[1];
		sPrice1 = getTestdata("Price",XLSheetUserIDs).split(";")[1];
