...
//		By androidDollarSign= By.xpath("//android.widget.TextView[@resource-id='com.td:id/account_rewards_balance");
	...
	public void rewardsNotVisible()  {
		...
		*/
		...
		/**
		* This method will verify the cash back rewards text under Summary tab in Credit Page
		* 
		* @throws NoSuchElementException
		* 
		* 
		...
		*/
		...
		/**
		* This method will verify the currency value has not exceeded two decimals in Credit Page
		 * @throws IOException 
		* 
		* @throws NoSuchElementException
		* 
