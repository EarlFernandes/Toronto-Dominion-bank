...
//		System.out.println(((AppiumDriver) CL.GetDriver()).getAppStringMap().toString());
...
//				String xpath = "//android.widget.TextView[@text='" + mobileAction.getAppString("feedback_default_title") + "']";
//				System.out.println("xpath:" +  xpath);
//				feedback_title = mobileAction.verifyElementUsingXPath(xpath, "Feedback Title");		
//			}else{
...
//		}
	...
	public void VerifyEmotionsAnimateFromTopToBottom(){
		...
		try{
			if(CL.getTestDataInstance().getMobilePlatForm().equalsIgnoreCase("Android")){
				MoodList =((AppiumDriver) CL.GetDriver()).findElements(By.xpath("//android.widget.TextView[@resource-id='com.td:id/nav_row_profile_title']"));
			}else{
	...
	public void ClickGreatLink(){
		...
		try{
			if(CL.getTestDataInstance().getMobilePlatForm().equalsIgnoreCase("Android")){
				String xpath = "//android.widget.TextView[@resource-id='com.td:id/nav_row_profile_title' and @text='" + mobileAction.getAppString("feedback_mood_great") + "']";
				System.out.println("xpath:" +  xpath);
...
//				String xpath = "//*[@label='" + mobileAction.getAppString("nav_drawer_items_feedback") + "']";
//				System.out.println("xpath:" +  xpath);
//				couldvebeenbetter_link = mobileAction.verifyElementUsingXPath(xpath, "Great Link");
...
//		try{
//			if(CL.getTestDataInstance().getMobilePlatForm().equalsIgnoreCase("Android")){
//				String xpath = "//android.widget.TextView[@resource-id='com.td:id/nav_row_profile_title' and @text='" + mobileAction.getAppString("somethings_broken_action_bar") + "']";
//				System.out.println("xpath:" +  xpath);
//				itwasntworking_link = mobileAction.verifyElementUsingXPath(xpath, "Somethings broken Link");		
//			}else{
////				String xpath = "//*[@label='" + mobileAction.getAppString("nav_drawer_items_feedback") + "']";
////				System.out.println("xpath:" +  xpath);
////				itwasntworking_link = mobileAction.verifyElementUsingXPath(xpath, "Somethings broken Link");
...
//				String xpath = "//*[@label='" + mobileAction.getAppString("nav_drawer_items_feedback") + "']";
//				System.out.println("xpath:" +  xpath);
//				send_feedback_now = mobileAction.verifyElementUsingXPath(xpath, "Send Feedback Now");
//			}
//		}catch (NoSuchElementException | IOException e) {
//			try {
//				mobileAction.GetReporting().FuncReport("Fail", "No such element was found on screen: " + e.getMessage());
