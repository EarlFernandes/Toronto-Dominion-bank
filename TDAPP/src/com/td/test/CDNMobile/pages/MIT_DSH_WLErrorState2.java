...
private static MIT_DSH_WLErrorState2 MIT_DSH_WLErrorState2;
	...
	@iOSFindBy(xpath = "(//*[@label='TRADE' or @label='NÉGOCIATION' or @label='交易' or @label='交易'])[2]")
		...
		try {
			 ...
			 if (mobileAction.isObjExists(btnSwitchNow, 2)) 
			 {
				...
				mobileAction.verifyElementIsDisplayed(TandCicon, "TandCicon");
				 ...
				 mobileAction.FuncVerifyTextEquals(TandCMsg,
							getTextInCurrentLocale(StringArray.ARRAY_DASHBOARD_WLERRORMSG));
