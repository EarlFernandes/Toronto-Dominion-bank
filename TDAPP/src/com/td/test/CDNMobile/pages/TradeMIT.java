...
public class TradeMIT extends _CommonPage {
	...
	@iOSFindBy(xpath = "//*[@label='Trade' or @label='N�gociation']") //@Author - Sushil 02-Feb-2017
	//@iOSFindBy(xpath = "")
	...
	@iOSFindBy(xpath = "//*[@label='CANCEL' or @label='ANNULER']")//@Author - Sushil 03-Feb-2017
	...
	@iOSFindBy(xpath = "//*[@label='Enter name or symbol' or contains(@label,'Votre compte n'est pas')]")//@Author - Sushil 03-Feb-2017
	//@AndroidFindBy(xpath = "//android.widget.EditText[@resource-id='com.td:id/edit_search_quote' and @text='Enter name or symbol']")
	@AndroidFindBy(id="com.td:id/error_text")
	private MobileElement InEligibleAccountErr;

	/*@iOSFindBy(xpath = "")
	@AndroidFindBy(xpath = "//android.widget.EditText[@resource-id='com.td:id/edit_search_quote' and @text='Enter name or symbol' and @index=0]")
	//@AndroidFindBy(xpath = "//android.widget.LinearLayout[@index=1]")
	private MobileElement Enter_Symbol;*/
	
	/*@iOSFindBy(xpath = "")
	@AndroidFindBy(xpath = "//android.widget.TextView[@text='Watchlists' and @index=0]")
	private MobileElement Investing_Watchlists;*/
...
/*	@iOSFindBy(xpath = "//*[@label='Stocks & ETFs'] ")
	...
	public void verifyDefaultStrategies() //@Author - Sushil 02-Feb-2017
	{
		...
		try{
			...
			mobileAction.FuncClick((MobileElement)CL.GetDriver().findElement(By.xpath(xpathOrderType)), getTestdata("OrderType", "UserIDs"));
			mobileAction.FuncClick(stocks_ETFs, "stocks_ETFs");
		}
		catch(Exception e)
		{
	...
	public void verifyOrderTypeList(String listOrderType) //@Author - Sushil 02-Feb-2017
	{
		try
		{
			...
			{
/*				if(items[i].equalsIgnoreCase("Stocks & ETF's"))
					tempStr = "Stocks & ETF";
				else
					tempStr = items[i];*/
				if(CL.getTestDataInstance().getMobilePlatForm().equalsIgnoreCase("Android"))
