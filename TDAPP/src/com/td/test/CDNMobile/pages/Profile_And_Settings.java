...
public class Profile_And_Settings extends _CommonPage {
	...
	String preferences = "Profile & Settings | Profil et param�tres";
	...
	@iOSFindBy(xpath = "//*[@label='Security Questions' or @label ='Questions de s�curit�']")
	...
	@iOSFindBy(xpath = "//*[@label='Quick Access Settings' or @label='Param�tres du Acc�s rapide']")
	...
	@iOSFindBy(xpath = "//*[@label='TD for Me Settings' or @label='Param�tres de TD et moi']")
	...
	@iOSFindBy(xpath = "//*[@label=\"What's New\" or @label='Nouveaut�s']")
