...
public class MLCancelOrderReceipt extends _CommonPage{
	...
	@iOSFindBy(xpath = "//*[contains(@label,'1st') or contains(@label,'1re')]/../*[2]") //@Author - Sushil 21-Mar-2017
	...
	@iOSFindBy(xpath = "//*[contains(@label,'2nd') or contains(@label,'2e')]/../*[2]") //@Author - Sushil 21-Mar-2017
	...
	@iOSFindBy(xpath = "//*[@label='Home' or @label='Accueil']") //@Author - Sushil 23-Mar-2017
