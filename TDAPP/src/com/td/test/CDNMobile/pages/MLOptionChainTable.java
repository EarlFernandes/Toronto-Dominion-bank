...
public class MLOptionChainTable extends _CommonPage{
	...
	@iOSFindBy(xpath = "//XCUIElementTypeOther[@label='Expiry Type,Monthly' or contains(@label,'Chaque mois')]") //@Author - Sushil 03-Apr-2017
	...
	@iOSFindBy(xpath = "//XCUIElementTypeStaticText[contains(@label,'Expiry Type') or contains(@label,'expiration')]") //@Author - Sushil 03-Apr-2017
