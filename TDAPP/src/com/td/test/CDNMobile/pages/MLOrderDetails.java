...
public class MLOrderDetails extends _CommonPage {
	...
	@iOSFindBy(xpath = "//XCUIElementTypeStaticText[contains(@label,'All change and cancel') or contains(@label,'Toute demande de modification')]")//@Author - Sushil 03-Mar-2017
	...
	@iOSFindBy(xpath = "//XCUIElementTypeOther[@label='Order Details' or contains(@label,'D�tails de')]") //@Author - Sushil 29-Mar-2017
	@AndroidFindBy(xpath = "//*[(@text='Order Details' or contains(@text,'D�tails de')) and @resource-id='android:id/action_bar_title']")
	...
	@iOSFindBy(xpath = "//XCUIElementTypeCell[2]/XCUIElementTypeStaticText[3]") //@Author - Sushil 08-Feb-2017
	@AndroidFindBy(id="com.td:id/txt_price")
	private MobileElement Quote_txt_price;
	
	@iOSFindBy(xpath = "//XCUIElementTypeCell[2]/XCUIElementTypeStaticText[4]") //@Author - Sushil 08-Feb-2017
	...
	@iOSFindBy(xpath = "//*[contains(@label,'1st Leg') or contains(@label,'1re')]/../following-sibling::XCUIElementTypeCell[1]/*[1]") //@Author - Sushil 21-Mar-2017
	...
	@iOSFindBy(xpath = "//*[contains(@label,'1st') or contains(@label,'1re')]/../following-sibling::XCUIElementTypeCell[2]/*[1]") //@Author - Sushil 16-Feb-2017
	...
	@iOSFindBy(xpath = "//*[contains(@label,'1st') or contains(@label,'1re')]/../following-sibling::XCUIElementTypeCell[2]/*[2]") //@Author - Sushil 16-Feb-2017
	...
	@iOSFindBy(xpath = "//*[contains(@label,'Confirmation') or contains(@label,'confirmation')]/../following-sibling::XCUIElementTypeCell[3]/*[1]") //@Author - Sushil 21-Mar-2017
	...
	@iOSFindBy(xpath = "//*[contains(@label,'Confirmation') or contains(@label,'confirmation')]/../following-sibling::XCUIElementTypeCell[3]/*[2]") //@Author - Sushil 21-Mar-2017
	...
	@iOSFindBy(xpath = "//*[contains(@label,'2nd') or contains(@label,'2e')]/../following-sibling::XCUIElementTypeCell[2]/*[1]") //@Author - Sushil 16-Feb-2017
	...
	@iOSFindBy(xpath = "//*[contains(@label,'2nd') or contains(@label,'2e')]/../following-sibling::XCUIElementTypeCell[2]/*[2]") //@Author - Sushil 16-Feb-2017
	//@AndroidFindBy(xpath = "//*[contains(@text,'1st') or contains(@text,'1re')]/../following-sibling::android.widget.LinearLayout[@resource-id='com.td:id/ticker_layout']/android.widget.TextView")
	...
	@iOSFindBy(xpath = "//*[contains(@label,'Confirmation') or contains(@label,'confirmation')]") //@Author - Sushil 21-Mar-2017
	...
	@iOSFindBy(xpath = "//XCUIElementTypeStaticText[@label='Price' or @label='Cours']/../*[2]") //@Author - Sushil 21-Mar-2017
	@AndroidFindBy(xpath="//android.widget.TextView[@text='Price' or @text='Cours']/../*[2]/*[1]")
	private MobileElement price;
	
	@iOSFindBy(xpath = "//XCUIElementTypeStaticText[contains(@label,'Shareholder Type') or contains(@label,'Type d')]/../*[2]") //@Author - Sushil 21-Feb-2017
	...
	@iOSFindBy(xpath = "//*[contains(@label,'Order Placed') or contains(@label,'Ordre pass')]") //@Author - Sushil 21-Mar-2017
	...
	@iOSFindBy(xpath = "//*[@label='Cancel Order' or contains(@label,'Annuler')]") //@Author - Sushil 21-Mar-2017
	@AndroidFindBy(id="com.td:id/change_order_btn")
...
/*			mobileAction.verifyElementIsDisplayed(ordersTab, "Orders Tab");
			...
			mobileAction.verifyElementTextContains(leg1ActQntDetails, getTestdata("Action",XLSheetUserIDs) + " " + getTestdata("Leg1Qunatity",XLSheetUserIDs) + " " + getTestdata("Symbol",XLSheetUserIDs));
			...
			/*String scomfr = mobileAction.FuncGetValByRegx(mobileAction.FuncGetText(leg1ConfirmationNumberDeatils),"([A-Z])(-)([0-9])");
			...
			mobileAction.verifyElementTextContains(leg2ActQntDetails, getTestdata("Leg2Action2",XLSheetUserIDs) + " " + getTestdata("Leg2Qunatity",XLSheetUserIDs) + " " + getTestdata("Symbol",XLSheetUserIDs));		
...
/*			mobileAction.waitForElement(lblACCOUNTS);
			...
			mobileAction.verifyElementIsDisplayed(lbl1stLegActQnt, "lbl1stLegActQnt");
			mobileAction.verifyElementTextContains(leg1ActQntDetails, getTestdata("Leg1Action2",XLSheetUserIDs) + " " + getTestdata("Leg1Qunatity",XLSheetUserIDs) + " " + getTestdata("Symbol",XLSheetUserIDs));
