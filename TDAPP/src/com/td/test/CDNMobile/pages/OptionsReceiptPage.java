...
private void Decorator() {
	PageFactory.initElements(
		...
		@iOSFindBy(xpath = "//*[@label='Your request to cancel the order was received.' or contains(@label,'Demande')]") //@Author - Sushil 21-Mar-2017
		...
		@iOSFindBy(xpath = "//*[contains(@label,'Order') or contains(@label,'ordre')]") //@Author - Sushil 21-Mar-2017
		@AndroidFindBy(xpath = "//*[contains(@text,'Order') or contains(@text,'ordre')]")
		private MobileElement Order;
		
		@iOSFindBy(xpath = "//*[@label='Order' or @label='ordre']/../*[2]") //@Author - Sushil 21-Mar-2017
...
/*		String sCurrentMonth = format2.split(";")[2];
		...
		mobileAction.verifyElementTextContains(OrderDetails, getTestdata("Action",XLSheetUserIDs) + " " + getTestdata("Quantity",XLSheetUserIDs) + " " + getTestdata("Symbol",XLSheetUserIDs));
