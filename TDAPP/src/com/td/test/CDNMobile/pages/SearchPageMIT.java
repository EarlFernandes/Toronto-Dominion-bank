...
public class SearchPageMIT extends _CommonPage {
	...
	@iOSFindBy(xpath = "//*[@label='RESULTS' or @label='R�SULTATS']") //@Author - Sushil 08-Feb-2017
	@AndroidFindBy(id="com.td:id/txt_results")
	private MobileElement txt_results;
	
	@iOSFindBy(xpath = "//*[@label='RECENT SEARCHES' or @label='RECHERCHES R�CENTES']") //@Author - Sushil 08-Feb-2017
