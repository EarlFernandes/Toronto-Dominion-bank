...
//	@iOSFindBy(xpath = "//*[@label='Enter name or symbol' or contains(@label,'Entrez le')]") //@Author - Sushil 03-Feb-2017
	@iOSFindBy(xpath = "//*[@name='TextField_0' or @name='SYMBOL_SEARCH_CELL_1']") // @Author - Sushil
													// 03-Feb-2017
	...
	@iOSFindBy(xpath = "//*[@label='Enter name or symbol']") // @Author - Sushil
																// 03-Feb-2017
	...
	@iOSFindBy(xpath = "//*[@label='RECENT SEARCHES' or @label='RECHERCHES RÉCENTES']") // @Author
																						// -
																						// Sushil
																						// 08-Feb-2017
	...
	@iOSFindBy(xpath = "//XCUIElementTypeCell[4]/XCUIElementTypeStaticText[4]") // @Author
																				// -
																				// Sushil
																				// 08-Feb-2017
	...
	public void verifySymbolSearchResults()// @Author - Sushil 07-Feb-2017
	{
		...
		try {
			 ...
			 * xpathSymbolFlag_ios; //mobileAction.selectItemFromList(, item);
			 * mobileAction.FuncClick(search_symbol, "search_symbol");
			 * //mobileAction.FuncSendKeys(search_symbol,"TD ");
			 * enterSymbol(search_symbol,"TD");
			 * if(CL.getTestDataInstance().getMobilePlatForm().equalsIgnoreCase(
			 * "Android")) mobileAction.FuncHideKeyboard();
			...
			// mobileAction.verifyElementIsDisplayed(search_txtSearchTitle,
			// "search_txtSearchTitle");
	...
	public void enterSymbol(MobileElement mEle, String symbol) {
		try {
			...
			if (CL.getTestDataInstance().getMobilePlatFormVersion().contains("6")
				...
				((RemoteWebDriver) CL.GetDriver()).getKeyboard().pressKey(symbol + " ");
				((RemoteWebDriver) CL.GetDriver()).getKeyboard().pressKey(Keys.BACK_SPACE);
				CL.GetReporting().FuncReport("Pass", "Symbol " + symbol  +  " entered.");
			}
	...
	public void clickFirstSymbol(String sSymbolName)// @Author - Sushil
													// 05-May-2017
	{
		Decorator();
		try {
	...
	public void clickFirstSymbol1(String sSymbolName)// @Author - Sushil
														// 05-May-2017
	{
		Decorator();
		try {
