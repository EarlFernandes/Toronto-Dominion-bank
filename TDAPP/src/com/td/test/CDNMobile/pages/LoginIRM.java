...
public class LoginIRM extends _CommonPage {
	...
	private static MobileElement errorText;
	...
	@AndroidFindBy(xpath = "//android.widget.Switch[@resource-id= 'com.td:id/remember_switch' and @text='YES']")
	private static MobileElement rememberMe_button_on;
	...
	private static MobileElement logined_page_Header;
	...
	public static MobileElement geterror() {
		return errorText;
	}
	
	public static MobileElement logined_page_Header() {
		return logined_page_Header;
	}
