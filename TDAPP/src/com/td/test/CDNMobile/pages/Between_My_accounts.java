...
public class Between_My_accounts extends _CommonPage {
    ...
    private MobileElement from_Accnt;
    ...
    String verify_to_acnt = "//android.widget.TextView[@resource-id='com.td:id/accntNumberSum' and @text='" + to_account
	    + "']";
    int i = 1;
    String from_accounts_table = "//XCUIElementTypeApplication/XCUIElementTypeWindow/XCUIElementTypeOther[2]/XCUIElementTypeOther[2]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeTable[1]";
    ...
    public void verifyFromAccounts() throws Exception {
    	...
    	String accountsList[] = from_account.split(",");
    	for (int i = 0; i < accountsList.length; i++) {
    	mobileAction.FuncClick(from_Accnt, "From Account");
