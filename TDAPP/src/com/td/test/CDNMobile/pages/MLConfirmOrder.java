...
public class MLConfirmOrder  extends _CommonPage{
	...
	@iOSFindBy(xpath = "//*[@label='Back' or @label='Retour']") //@Author - Sushil 21-Mar-2017
	...
	@iOSFindBy(xpath = "//XCUIElementTypeStaticText[contains(@label,'Commission')]") //@Author - Sushil 21-Feb-2017
	@AndroidFindBy(xpath="//android.widget.TextView[contains(@text,'Commission')]")
	private MobileElement lblCommission;
	
	@iOSFindBy(xpath = "//XCUIElementTypeStaticText[contains(@label,'Commission')]/../*[2]") //@Author - Sushil 21-Feb-2017
	...
	@iOSFindBy(xpath = "//XCUIElementTypeStaticText[contains(@label,'Buying Power Required') or contains(@label,'Pouvoir d')]") //@Author - Sushil 21-Feb-2017
	...
	@iOSFindBy(xpath = "//XCUIElementTypeStaticText[contains(@label,'Buying Power') or contains(@label,'Pouvoir d')]/../*[2]") //@Author - Sushil 21-Feb-2017
	...
	@iOSFindBy(xpath = "//*[@label='Cancel' or @label='Annuler']") //@Author - Sushil 21-Mar-2017
...
//			mobileAction.verifyElementTextContains(timestamp, sCurrentMonth + " " + sCurrentDate + "," + sCurrentYear);
			...
			mobileAction.verifyElement(leg1Details, getTestdata("Action",XLSheetUserIDs) + " " + getTestdata("Leg1Qunatity",XLSheetUserIDs) + " " + getTestdata("Symbol",XLSheetUserIDs));
			
			mobileAction.verifyElementIsDisplayed(lbl2ndLeg, "2nd Leg");
			mobileAction.verifyElement(leg2Details, getTestdata("Leg2Action2",XLSheetUserIDs) + " " + getTestdata("Leg2Qunatity",XLSheetUserIDs) + " " + getTestdata("Symbol",XLSheetUserIDs));
