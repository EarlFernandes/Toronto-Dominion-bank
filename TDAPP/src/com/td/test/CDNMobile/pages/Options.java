...
public class Options extends _CommonPage {
	...
	@iOSFindBy(xpath = "//XCUIElementTypeStaticText[contains(@label,'Trading Password') or contains(@label,'Mot de passe de négociation')]/../XCUIElementTypeSecureTextField[1]") // @Author
																																													// -
																																													// Sushil
																																													// 03-Mar-2017
	...
	@iOSFindBy(xpath = "//*[contains(@label,'Trigger Price') or contains(@label,' Déclenchement')]/../*[2]")
	@AndroidFindBy(xpath = "//*[contains(@text,'Trigger  Price') or contains(@text,' Déclenchement')]/../*[@resource-id='com.td:id/amountEditText']")
	...
	@iOSFindBy(xpath = "//XCUIElementTypeButton[contains(@label,'Preview Order') or contains(@label,'Aperçu de l')]")
	...
	// @iOSFindBy(xpath =
	// "(//XCUIElementTypeStaticText[@label='180']/../../XCUIElementTypeOther[1]/XCUIElementTypeStaticText[1]")
	...
	/*
	 * @iOSFindBy(xpath =
	 * "//XCUIElementTypeStaticText[@label='Enter name or symbol' or contains(@label,'nom ou le symbole')]"
	 * )
	 * 
	 * @AndroidFindBy(xpath =
	 * "//android.widget.EditText[@text='Enter name or symbol' or contains(@text,'nom ou le symbole')]"
	 * ) //changed by rashmi private MobileElement searchSymbol;
	 */
	...
	@AndroidFindBy(xpath = "//android.view.View[@text='Options' or @content-desc='Options']") // changed
																								// by
																								// rashmi
	...
	@AndroidFindBy(xpath = "//android.widget.EditText[@resource-id='symbol-search' and (@text='Enter name or symbol' or contains(@text,'Entrer un nom'))]") // changed
																																							// by
																																							// rashmi
	...
	public void verifyOptionConfirmOrder() {
		...
		try {
			...
			mobileAction.verifyElement(Orderdetails, getTestdata("Action", XLSheetUserIDs) + " "
