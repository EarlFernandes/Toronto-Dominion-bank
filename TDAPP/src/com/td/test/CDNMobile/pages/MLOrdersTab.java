...
public class MLOrdersTab extends _CommonPage {
	...
	// @iOSFindBy(xpath = "//*[contains(@label,'EDT') or
	// contains(@label,'HAE')]/../*[4]/*[2]") //@Author - Sushil 21-Mar-2017
	...
	public void verifyMLOrdersTabDetails() {
		...
		try {
			...
			if (CL.getTestDataInstance().getMobilePlatForm().equalsIgnoreCase("Android"))
				mobileAction.FuncGetTextByxpath(
						"//*[contains(@text,'" + getTestdata("OrderStatus", XLSheetUserIDs) + "')]");
			else
