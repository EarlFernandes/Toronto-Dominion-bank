...
public class EventCase {
	...
	private enum functionNames {
		...
		Transfers_clickManageContactsLink, ManageContacts_verifyPageHEader, ManageContacts_clickAddContactPlusSign, ManageContacts_clickAddContactButton, ManageContacts_addContact, ManageContacts_clickAddContactfromPhone, ManageContacts_AddContactfromPhone, ManageContacts_clickContact, ManageContacts_verifySuccessMessage, ManageContacts_editContact, ManageContacts_noDeleteContact, ManageContacts_deleteContact, ManageContacts_verifyContactEditSuccessMsg, ManageContacts_MultiProfileEditContact, ManageContacts_MultiProfileAddContact, ManageContacts_MultiProfileDeleteContact, ManageContacts_verifyContactDeleteSuccessMsg, Interac_e_Registration_clickContinueButton, Interac_e_Registration_verifyErrorText, Interac_e_Registration_registerPersonalUser, Interac_e_Registration_registerBusinessUser, Interac_e_Registration_registerMultiProfileUser, Interac_e_Registration_clickGoBackHome, Interac_e_Registration_verifyDetails, Interac_e_Registration_verifyBusinessDetails, Interac_e_Registration_verifyRegSuccessMessage, Interac_e_Registration_clickRegisterAnotherProfile, Interac_Send_Money_sendMoneyWithError, Interac_Send_Money_sendMoney, Interac_Send_Money_sendMoneyVerifySuccessMsg, Interac_Send_Money_sendMoneyVerifyDetails, Executor_createPersonalProfile, Executor_createBusinessProfile, Executor_createMultiProfile, HomeScreen_clickSendMoney,

		Interac_e_Transfer_clickContinueButton, Profile_And_Settings_clickPaymentsAndTransfers, Interac_e_Transfer_verifyErrorText, Interac_e_Transfer_registerUser, Interac_e_Transfer_verifyDetails, Interac_e_Transfer_verifyRegSuccessMessage,
