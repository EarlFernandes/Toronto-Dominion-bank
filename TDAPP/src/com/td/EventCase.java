...
import com.td.test.CDNMobile.pages.WebViewPage;
...
public class EventCase {
	...
	private enum functionNames {
		...
		// myspend
		// <<<<<<< HEAD
		// DailyDigest_verifyHeader, DailyDigest_verifyHomePage,
		// DailyDigest_verifyBackButton, DailyDigest_verifySpending,
		// DailyDigest_verifyCategorySpike, DailyDigest_clickCategoryTab,
		// DailyDigest_verifyCategoryMessage, Logout_logout,
		// MySpend_RegistrationFlow, MoneyPath_moneyPathFunctionality,
		// Preferences_verifyPreferenceTabs,
		// Preferences_verifyRealTimeNotifications,
		// Preferences_verifyDailyDigestNotifications,
		// TourPage_clickConnectTDApp, Spending_Insight_verifyPageHeader,
		// Spending_Insight_clickMenuButton, SideMenu_clickPreferences,
		// SideMenu_clickSpendingByCategory, SideMenu_verifyDeepLinks,
		// SideMenu_clickSideMenu, SpendingSpike_verifySpikesCategories,
		// SpendingByCategory_verifySpikes, SpendingInsight_clickDailyDigest,
		// SideMenu_clickDailyDigest, SpendingSpike_pageMessages,
		// Preferences_verifyPageHeader, Preferences_enableAccounts,
		// Preferences_EnableAllAccounts, Preferences_DisableAllAccounts,
		// Spending_Insight_verifyPreferencesDisabled,
		// Spending_Insight_verifyPreferencesEnabled,
		// SideMenu_clickSpendingHistory, SideMenu_clickSpendingSpikes,
		// SideMenu_clickSpendingInsights, SideMenu_clickTransactionHistory,
		// SpendingHistory_verifyNoSpendingHistory,
		// SpendingHistory_verifySpendingHistory,
		// SpendingHistory_clickMonthIcon, SpendingHistory_verifyTabs,
		// SpendingHistory_clickHomeButton,
		// SpendingHistory_verifySpendingHistoryHeader,
		// spendingByCategory_verifyPageHeader,
		// Spending_Insight_logoutTDMySpend,
		// Spending_Insight_clickAndVerifyLogout,
		// Spending_Insight_clickMoneyPathButton,
		// SpendingInsights_verifySpendingInsightsPage,
		// SpendingHistory_clickSpendingHistory,
		// spendingByCategory_verifyCategories,
		// spendingByCategory_changeCategoryForAllTabs,
		// SpendingByCategory_clickHistoricalInsightBtn,
		// SpendingSpike_verifyCurrentMonthSpending,
		// spendingByCategory_changeCategory,
		// TransactionHistory_verifyNoTransactionsFound,
		// TransactionHistory_verifyTransactions,
		// TransactionHistory_verifyPageHeader,
		// TransactionHistory_transacHistoryFunctionality,
		// TDAppHomePage_verifyPageHeader, TDAppHomePage_clickTDMySpend,
		// SideMenu_clickMyAccounts, SideMenu_clickGetTDAppButton,
		// click_PreferencesLink,
		// =======
