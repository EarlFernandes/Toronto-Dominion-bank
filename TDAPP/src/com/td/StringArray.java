...
public final class StringArray {
	...
	public static final String[] ARRAY_MF_TRANSACTION_DETAIL ={"Transaction Details","Détails de l’opération","交易详情","交易詳情"};
	public static final String[] ARRAY_MF_TRANSACTION_DATE ={"Date","Date","日期 ","日期 "};
	public static final String[] ARRAY_MF_TRANSACTION_TYPE ={"Transaction Type","Type d’opération","交易类型","交易類型常"};
	public static final String[] ARRAY_MF_TRANSACTION_GROSS_AMOUNT ={"Gross Amount","Montant brut","总金额","總金額"};
	public static final String[] ARRAY_MF_TRANSACTION_CHARGE ={"Transaction Charge","Frais d’opération","交易收费","交易費用"};
	...
	public static final String[] ARRAY_MF_TRANSACTION_UNIT ={"Transaction Units","Parts visées par l’opération","交易单位数量","交易單位數"};
	...
	public static final String[] ARRAY_QUICK_ACCESS_SETTINGS = {"Quick Access Settings", "Paramètres Accès rapide", "特快结余查询设定", "特快結餘查詢設定"};
	...
	public static final String[] ARRAY_CUSTOMIZE_NOTIFICATIONS = {"Customize Notifications", "Personnaliser les avis", "定制通知", "定制通知"};
	public static final String[] ARRAY_TD_FOR_ME_NOTIFICATIONS = {"TD for Me Notifications", "Avis TD et moi", "TD for Me 通知", "TD for Me 通知"};
	public static final String[] ARRAY_ENABLE_NOTIFICATIONS = {"Enable Notifications", "Activer les notifications", "启用通知", "启用通知"};
