...
public class PendingInteracTransfer extends _CommonPage{
	...
	@iOSFindBy(xpath = "//*[@label='Don't Cancel']")
	...
	@iOSFindBy(id = "//*[@label='Interac e-Transfer reclaimed and deposited successfully']")
	...
	public void verifylistofsender() throws Exception {
		...
		try {
			if(platformName.equalsIgnoreCase("ios")){
				...
				mobileAction.verifyElementIsDisplayed(verifysender," Sender list is displaying with name and email address");
			}
			else
			{
